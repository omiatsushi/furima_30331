...
ActiveRecord::Schema.define(version: 2021_03_08_013935) do
  ...
  create_table "infomations", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["order_id"], name: "index_infomations_on_order_id"
  end
  ...
  create_table "users", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.string "second_name_furigana", default: "", null: false
  ...
  add_foreign_key "infomations", "orders"
